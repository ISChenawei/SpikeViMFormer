...
@register_model
def spiking_metaformer_8_384(pretrained=False, **kwargs):
    model = Spiking_vit_MetaFormer(
        embed_dims=[96, 192, 384, 480],
        num_heads=8,
        **kwargs
    )
    return model
...
@register_model
def spiking_metaformer_8_512(pretrained=False, **kwargs):
    model = Spiking_vit_MetaFormer(
        embed_dims=[128, 256, 512, 640],
        num_heads=8,
        **kwargs
    )
    return model
...
@register_model
def spiking_metaformer_8_768(pretrained=False, **kwargs):
    model = Spiking_vit_MetaFormer(
        embed_dims=[192, 384, 768, 960],
        num_heads=8,
        **kwargs
    )
    return model
