...
from .Spikeformer import make_spike_model
import torch
import numpy as np
...
class two_view_net(nn.Module):
    def __init__(self, class_num, block=4, return_f=False, resnet=False):
        ...
        self.model_1 = make_spike_model(num_class=class_num, block=block, return_f=return_f, resnet=resnet)
...
class three_view_net(nn.Module):
    def __init__(self, class_num, share_weight=False, block=4, return_f=False, resnet=False):
        ...
        if self.share_weight:
            ...
            self.model_2 = make_spike_model(num_class=class_num, block=block, return_f=return_f, resnet=resnet)
